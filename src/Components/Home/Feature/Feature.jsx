...
import featureImg from '../../../Assets/Images/wallet-bg.png';
        ...
        <div className='text-start'>
            <section className="bg-gray-50 text-gray-800">
                <div className="container max-w-5xl px-4 py-12 mx-auto">
                    <h2 className='text-center text-3xl font-bold mb-10'>আমরা আপনাকে কি সুবিধা দিতে পারি?</h2>
                    <div className="grid gap-4 mx-4 sm:grid-cols-12">
                        <div className="col-span-12 sm:col-span-3">
                            <div className="text-center sm:text-left mb-14 before:block before:w-24 before:h-3 before:mb-5 before:rounded-md before:mx-auto sm:before:mx-0 before:bg-violet-400">
                                <h3 className="text-3xl font-semibold">লোন সংক্রান্ত </h3>
                                <span className="text-sm font-bold tracki uppercase text-gray-400">সব সমস্যার সমাধান টাকাওয়ালাতে</span>
                        ...
                        <div className="relative col-span-12 px-4 space-y-6 sm:col-span-9">
                            <div className="col-span-12 space-y-12 relative px-4 sm:col-span-8 sm:space-y-8 sm:before:absolute sm:before:top-2 sm:before:bottom-0 sm:before:w-0.5 sm:before:-left-3 before:bg-gray-700">
                                <div className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:bg-violet-400">
                                    <h3 className="text-xl font-semibold tracki">এক জায়গায় সব ব্যাংকের লোন  </h3>
                                ...
                                <div className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:bg-violet-400">
                                    <h3 className="text-xl font-semibold tracki">যেকোনো সাইজের ব্যবসা </h3>
                                ...
                                <div className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:bg-violet-400">
                                    <h3 className="text-xl font-semibold tracki">ঝামেলা মুক্ত লোন ব্যবস্থা </h3>
